  ...
  return (
    <AuthPageLayout>
      ...
      <div className={classes.myProfileForm}>
        {isLoading && (
          <div className={classes.myProfileForm__loadingContainer}>
            <Loading className={classes.myProfileForm__loading} />
            <Backdrop />
          </div>
        )}

        <div className={classes.myProfileForm__backgroundContainer}>
          <img
            src={userBackgroundSrc}
            alt="user's background"
            className={classes.myProfileForm__background}
          />
          <form className={classes.myProfileForm__backgroundUploadForm}>
        ...
        <div className={classes.myProfileForm__avatarAndTitleContainer}>
          <div className={classes.myProfileForm__avatarContainer}>
            <img
              src={userAvatarSrc}
              alt="user's avatar"
              className={classes.myProfileForm__avatar}
            />
            <form className={classes.myProfileForm__avatarUploadForm}>
          ...
          <div className={classes.myProfileForm__titleContainer}>
            <h1>Profile</h1>
            <p>Update your pictures and personal details.</p>
          </div>

          <button
            className={classes.myProfileForm__saveButton}
            onClick={onSaveForm}
          >
            Save
          </button>
        ...
        <form className={classes.myProfileForm__textForm}>
